        ...
        public static void PaintGradientBG(SKPaintSurfaceEventArgs e)
        {
            ...
            using (SKPaint paint = new SKPaint())
            {
                ...
                paint.Shader = SKShader.CreateLinearGradient(
                                    ...
                                    new SKColor[] { ((Color)App.Current.Resources["Top"]).ToSKColor(), ((Color)App.Current.Resources["Bottom"]).ToSKColor(), ((Color)App.Current.Resources["Bottom"]).ToSKColor(), ((Color)App.Current.Resources["Bottom"]).ToSKColor() },
                                    null,
